...
//		System.out.println("Order changed state: "+oldstate+" "+state);
	...
	//--------------methods for negotiation strategy-----------------------------
	public void setNegotiationStrategy(String strategy) {
		String oldstrategy = this.negstrategy;
		this.negstrategy = strategy;
		pcs.firePropertyChange("negotiationStrategy", oldstrategy, strategy);
